...
import com.lcwd.electronic.dtos.JwtRequest;
import com.lcwd.electronic.dtos.JwtResponse;
...
import com.lcwd.electronic.security.JwtHelper;
...
//@CrossOrigin("*")           if we use corsConfiguration bean in securityConfig
public class AuthController {
    ...
    //for print only current login  User Name
